...
export const metadata: Metadata = {
  ...
  description:
    "🔥 Современный фитнес-клуб Urban210 в Хабаровске. Безлимитный фитнес от 1300₽/мес. Тренажерный зал, кроссфит, групповые программы, спа-зона. ⭐ Лучшие тренеры города!",
  keywords:
    "фитнес клуб хабаровск, тренажерный зал, кроссфит хабаровск, групповые тренировки, спа зона, фитнес абонемент, urban210",
  ...
  openGraph: {
    ...
    description:
      "🔥 Современное оборудование, кроссфит, спа-зона. Присоединяйтесь к лучшему фитнес-клубу города!",
  ...
  twitter: {
    ...
    description: "Безлимитный фитнес от 1300₽. Кроссфит, спа-зона",
    images: [
  ...
  return (
    <html lang="ru" className="dark">
      <head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: "Urban210",
              description:
                "Современный фитнес-клуб в Хабаровске с тренажерным залом, кроссфитом и спа-зоной",
              url: "https://urban210.ru",
        ...
        <noscript>
          <div>
            <img src="https://mc.yandex.ru/watch/103720803" style={{ position: 'absolute', left: '-9999px' }} alt="" />
          </div>
        </noscript>
      </head>
